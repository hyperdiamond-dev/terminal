    ...
    <div class="container mx-auto py-8 px-4">
      <div class="max-w-screen-md mx-auto">
        ...
        <div class="text-center my-8">
          <div class="inline-block px-4 py-2 border-2 border-analog-blue bg-analog-blue/20 text-analog-blue font-bold uppercase text-sm mb-4">
            REVIEW MODE
          </div>
          ...
          <h1 class="text-3xl font-bold text-vhs-white text-shadow-vhs-blue my-4 uppercase tracking-wider">
            {module?.title}
          </h1>
          {module?.description && (
        ...
        <div class="border-2 border-analog-blue bg-analog-blue/10 px-4 py-3 mb-6">
          <p class="text-analog-blue font-bold uppercase text-center">
